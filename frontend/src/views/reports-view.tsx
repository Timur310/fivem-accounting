                        ...
                        {summary.memberRanking.map((m, i) => (
                          <div key={m.username} className="flex items-center gap-3 py-1.5 px-2 -mx-2 rounded-md hover:bg-white/[0.02] transition-colors duration-100">
                            ...
                            <span className="text-sm font-medium tabular-nums text-zinc-200">
                              {fmt(m.currencyTotal)}
                              {m.itemTotal > 0 && (
                                <span className="text-zinc-500 font-normal"> &middot; {fmtItems(m.itemTotal)} items</span>
                              )}
                            </span>
                          </div>
                        ))}
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                  <CardContent className="p-4">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <p className="text-xl font-medium tabular-nums tracking-tight text-zinc-100">{fmtItems(Math.abs(comparison.deltas.itemTotal))}</p>
