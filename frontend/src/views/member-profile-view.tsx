              ...
              <CardContent>
                ...
                {contribution.itemEntryCount > 0 && (
                  <p className="text-[11px] text-zinc-600 mt-0.5">
                    + {fmtItems(contribution.itemContributed)} in items ({contribution.itemEntryCount} entries)
                  </p>
                )}
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                {payoutStats.itemReceived > 0 && (
                  <p className="text-[11px] text-zinc-600 mt-0.5">+ {fmtItems(payoutStats.itemReceived)} in items</p>
                )}
              </CardContent>
            </Card>
          </div>
