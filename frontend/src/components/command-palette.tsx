  ...
  return (
    ...
    >
      <Command
        ...
        className="absolute top-[15%] left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] max-w-lg rounded-lg border border-[var(--line-2)] bg-[#101114] shadow-2xl shadow-black/50 overflow-hidden"
        onClick={(e) => e.stopPropagation()}
      >
        <Command.Input
          autoFocus
          placeholder={t('palette.placeholder')}
          className="w-full bg-transparent px-4 h-12 text-sm text-zinc-200 outline-none border-b border-[var(--line-1)] placeholder:text-zinc-600"
        />
